        ...
        <div class="well">
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input class="form-control"  name="sqlhost" type="text" placeholder="数据库 IP" value="127.0.0.1">
                </div>
            </div>
            <div class="form-group">
                <div class="input-group">
                    <div class="input-group-addon">数据库账户</div>
                    <input class="form-control" name="sqlname" type="text" placeholder=" 数据库账户" value="root">
                </div>
            </div>
            <div class="form-group">
                <div class="input-group">
            ...
            <div class="form-group">
                <div class="input-group">
                    ...
                    <input class="form-control" name="sqlnum" type="text" placeholder="数据库端口" value="3306">
                </div>
            </div>
            <div class="form-group">
                <div class="input-group">
                    <div class="input-group-addon">创建数据库</div>
                    <input class="form-control" name="namesql" type="text" placeholder="创建数据库" value="weixin">
                </div>
            </div>
            <div class="form-group">
                <div class="input-group">
                    <div class="input-group-addon">管理员账户</div>
                    <input class="form-control" name="u_name" type="text" placeholder="管理员账户" value="admin">
                </div>
            </div>
            <div class="form-group">
                <div class="input-group">
